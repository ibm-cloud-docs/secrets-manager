...
| Community plug-ins for Vault are not supported. | It is impossible to integrate a community plug-in for Vault with {{site.data.keyword.secrets-manager_short}}, unless it is written against a secrets engine that {{site.data.keyword.secrets-manager_short}} supports. |
...
{: caption="Known issues and limitations that apply to the {{site.data.keyword.secrets-manager_short}} service" caption-side="bottom"}
...
{: caption="{{site.data.keyword.secrets-manager_short}} limits per account" caption-side="bottom"}
...
| Total secrets | – |
{: caption="Secret group limits" caption-side="bottom"}
...
{: caption="Arbitrary secret limits" caption-side="bottom"}
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="IAM credential limits" caption-side="bottom"}
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="Key-value limits" caption-side="bottom"}
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="TLS certificate limits" caption-side="bottom"}
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="User credential limits" caption-side="bottom"}
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="Service credential limits" caption-side="bottom"}
