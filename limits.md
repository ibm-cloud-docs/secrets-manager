...
| No API support for disabling expiration after it was set for Arbitrary and Username-password secret types | Set an expiration date into the far future; for example, 12/31/2999. |
...
| Custom metadata | 10 KB |
| Version custom metadata | 10 KB |
{: caption="Table 9. Service credential limits" caption-side="top"}
