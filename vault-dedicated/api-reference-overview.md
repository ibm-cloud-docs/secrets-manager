...
| [Instance Management CLI reference](/docs/secrets-manager?topic=secrets-manager-management-cli-vault-dedicated) | {{site.data.keyword.cloud_notm}} CLI plug-in for managing your Vault Dedicated instance from the command line. |
| [Instance Management CLI change log](/docs/secrets-manager?topic=secrets-manager-management-cli-change-log-vault-dedicated) | History of changes to the Instance Management CLI plug-in. |
