...
1. [Create an access group](/docs/iam?topic=iam-groups&interface=ui#create_ag) for the users and service IDs that you want to give access to and add those users to the group.
