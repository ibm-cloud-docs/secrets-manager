...
If you have an API key that was generated by the IAM credentials secret engine and delete your instance of {{site.data.keyword.secrets-manager_short}}, you must also delete the secret from IAM. For more information, see [Managing user API keys](/docs/account?topic=account-userapikey).