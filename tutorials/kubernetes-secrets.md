...
# Secure secrets for apps that run in your Kubernetes cluster by using the basic or standard plan
...
### Create a trusted profile from CLI
{: #tutorial-kubernetes-secrets-trusted-profile-cli}
...
To work with VaaS and {{site.data.keyword.containershort}}, you need to create a cluster in your {{site.data.keyword.cloud_notm}} account and configure access to your VaaS instance.
