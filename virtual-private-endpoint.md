...
2. Define the `INSTANCE_ID` variable with your {{site.data.keyword.secrets-manager_short}} instance ID.
    ...
    Replace `<instance_id>` with the unique identifer for your {{site.data.keyword.secrets-manager_short}} service instance. To find your instance ID, you can go to the XYZ.
