...
You can now create a private instance of {{site.data.keyword.secrets-manager_short}} so that you can manage application secrets only over a private network connection.
...
### Configure the IAM secrets engine from the {{site.data.keyword.secrets-manager_short}} service UI
...
### View {{site.data.keyword.secrets-manager_short}} logs with {{site.data.keyword.la_full_notm}}
...
For more information, see [Viewing logs for {{site.data.keyword.secrets-manager_short}}](secrets-manager?topic=secrets-manager-platform-logs).
