...
Now available: Integration with {{site.data.keyword.containershort}} and {{site.data.keyword.openshiftshort}}
: You can now integrate {{site.data.keyword.secrets-manager_short}} so that you can centrally manage Ingress subdomain certificates and other secrets for your Kubernetes clusters. To learn more about this integration, check out the [{{site.data.keyword.containershort}} documentation](/docs/containers?topic=containers-ingress-types#manage_certs_secrets_mgr).
