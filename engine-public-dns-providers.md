...
{: caption="Prerequisites - CIS" caption-side="bottom"}
{: #cis-prereqs}
...
{: caption="Prerequisites - Classic infrastructure" caption-side="bottom"}
...
{: caption="Prerequisites - Manual DNS providers" caption-side="bottom"}
{: #manual-prereqs}
{: tab-title="Manual"}
{: tab-group="dns-provider-prereqs"}
{: class="simple-tab-table"}
...
{: #get-dns-provider-engine-value-ui}
{: ui}
...
{: #get-dns-provider-engine-value-cli}
{: cli}
...
{: #get-dns-provider-engine-value-api}
{: api}
