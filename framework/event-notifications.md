...
Depending on the type of secret that you're working with in the service, an event might not be generated by {{site.data.keyword.secrets-manager_short}}. For more information, refer to [Events by secret type](#events-by-secret-type).
{: note}
