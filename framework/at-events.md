...
The following sections describe the events that are generated for Trial and Standard plans, and for the Vault Dedicated plan. Due to the different architectures and capabilities of these plans, the events they generate differ significantly.

## Events for Trial and Standard plans
{: #at-events-trial-standard}

The following events are generated by Trial and Standard plan instances.

### Secrets events
{: #at-actions-secrets-trial-standard}
