...
![This image is a visual representation of the architecture for {{site.data.keyword.secrets-manager_short}}.](../images/secrets-arch.svg){: caption="{{site.data.keyword.secrets-manager_short}} architecture" caption-side="bottom" width="100%"}
