...
You can use {{site.data.keyword.secrets-manager_full}} to store, request, aand generate SSL or TLS certificates that you can use for your apps or services.
{: shortdesc}
...
18. Click **Create**.
    ...
    After a certificate is issued, you can deploy it to your integrated apps, download it, revoke it, or rotate it manually. Your private key for SSL or TLS is generated directly in {{site.data.keyword.secrets-manager_short}} and stored securely.
