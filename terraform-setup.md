...
6. From the [{{site.data.keyword.cloud_notm}} resource list](cloud.ibm.com/resources){: external}, select the {{site.data.keyword.secrets-manager_short}} instance that you created and note the instance ID.
