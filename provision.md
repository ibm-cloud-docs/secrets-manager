...
3. Create an instance of {{site.data.keyword.secrets-manager_short}} within that account and resource group.
    ...
    | Pricing plan (`plan`) | The pricing plan that you want to use. Use `869c191a-3c2a-4faf-98be-18d48f95ba1f` for `trial` or `7713c3a8-3be8-4a9a-81bb-ee822fcaac3d` for  `standard`. |
